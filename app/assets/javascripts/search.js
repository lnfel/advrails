		...
		template: {
			...
			method: function(value, item) {
				...
				var icon = item.feature_image ? 
					...
					` 
					: 
					`<svg class="bd-placeholder-img rounded-lg" width="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Image cap"><title>Placeholder</title><rect width="100%" height="100%" fill="#ffb5da"></rect><text x="50%" y="50%" fill="#ffffff" dy=".3em">${[item.type]}</text></svg>`;
